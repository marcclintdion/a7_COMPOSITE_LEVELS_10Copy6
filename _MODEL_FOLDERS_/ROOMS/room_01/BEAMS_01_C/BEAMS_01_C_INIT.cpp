...
//========================================================================                            
    //-----------------------------------------------------------------------------------                                              
    #ifdef WIN32                                                                                                                       
    loadTexture("_MODEL_FOLDERS_/ROOMS/room_01/BEAMS_01_C/BEAMS_01_C_DOT3.png",     BEAMS_01_C_NORMALMAP);     
    loadTexture("_MODEL_FOLDERS_/ROOMS/room_01/BEAMS_01_C/BEAMS_01_C.png",          BEAMS_01_C_TEXTUREMAP);    
    #endif                                                                                                                             
    //-----------------------------------------------------------------------------------                                              
