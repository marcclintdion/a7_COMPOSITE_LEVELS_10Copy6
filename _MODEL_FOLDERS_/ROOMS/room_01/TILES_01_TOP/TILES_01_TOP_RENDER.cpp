...
//==========================                                                    
    ...
    //------------------------                                                  
    Translate(modelWorld, TILES_01_TOP_POSITION[0] + setPosition[0],                   
                          TILES_01_TOP_POSITION[1] + setPosition[1],                   
                          TILES_01_TOP_POSITION[2] + setPosition[2]);                  
    ...
    //------------------------                                                  
    Rotate(modelRotation, TILES_01_TOP_ROTATE[0],                     
                          TILES_01_TOP_ROTATE[1],                     
                          TILES_01_TOP_ROTATE[2],                     
                          TILES_01_TOP_ROTATE[3]);                    
