...
//========================================================================                            
    //-----------------------------------------------------------------------------------                                              
    #ifdef WIN32                                                                                                                       
    loadTexture("_MODEL_FOLDERS_/ROOMS/room_01/TILES_01_TOP/TILES_01_TOP_DOT3.png",     TILES_01_TOP_NORMALMAP);     
    loadTexture("_MODEL_FOLDERS_/ROOMS/room_01/TILES_01_TOP/TILES_01_TOP.png",          TILES_01_TOP_TEXTUREMAP);    
    #endif                                                                                                                             
    //-----------------------------------------------------------------------------------                                              
