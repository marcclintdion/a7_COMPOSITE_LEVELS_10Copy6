...
//========================================================================                            
    //-----------------------------------------------------------------------------------                                              
    #ifdef WIN32                                                                                                                       
    loadTexture("_MODEL_FOLDERS_/ROOMS/room_01/BEAMS_01_B/BEAMS_01_B_DOT3.png",     BEAMS_01_B_NORMALMAP);     
    loadTexture("_MODEL_FOLDERS_/ROOMS/room_01/BEAMS_01_B/BEAMS_01_B.png",          BEAMS_01_B_TEXTUREMAP);    
    #endif                                                                                                                             
    //-----------------------------------------------------------------------------------                                              
